public class MyOperators {
    public static void main(String[] args) {
        ...
        // playing around - This is a kluge. I prefer to indent the answers then they are numbers, and only
        // a single answer. Multiple answers are better horizontally aligned.
        System.out.println("");
        System.out.println("-------------------------");
